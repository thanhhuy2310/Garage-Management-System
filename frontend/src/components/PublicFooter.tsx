    ...
    <>
      <section aria-labelledby="homepage-cta-title" className="bg-surface-subtle px-4 pb-16 sm:px-6 sm:pb-24">
        <div className="mx-auto grid w-full max-w-7xl overflow-hidden bg-accent text-white lg:grid-cols-[1fr_auto]">
          <div className="p-7 sm:p-10 lg:p-12"><p className="text-xs font-extrabold uppercase tracking-[0.18em] text-white/70">Đừng chờ đến khi xe hỏng nặng</p><h2 id="homepage-cta-title" className="mt-3 max-w-3xl text-2xl font-black uppercase leading-tight tracking-tight sm:text-4xl">Đặt lịch kiểm tra xe trong một phút.</h2><p className="mt-3 max-w-2xl text-base leading-7 text-white/80">Gara xác nhận giờ hẹn, kiểm tra và báo giá minh bạch trước khi thực hiện.</p></div>
