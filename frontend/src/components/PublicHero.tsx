  ...
  return (
    <section aria-label="Giới thiệu gara" className="public-hero relative isolate flex min-h-[690px] items-center overflow-hidden text-white lg:min-h-[760px]">
      ...
      <div className="relative mx-auto w-full max-w-7xl px-4 py-20 sm:px-6 lg:py-28">
        <div className="max-w-3xl">
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
            <button type="button" onClick={onBook} className="public-primary-button">Đặt lịch ngay <span aria-hidden="true">→</span></button>
            <button type="button" onClick={onViewServices} className="public-secondary-button">Khám phá dịch vụ</button>
          </div>
      ...
      <div className="absolute bottom-0 right-0 hidden items-center gap-4 bg-accent px-7 py-5 text-white lg:flex">
        <span className="grid h-11 w-11 place-items-center border border-white/30" aria-hidden="true"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="9" /><path d="M12 7v5l3 2" /></svg></span>
