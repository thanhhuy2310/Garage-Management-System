...
export const Icons = {
  ...
  eyeOff: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="m3 3 18 18"/><path d="M10.6 10.6a2 2 0 0 0 2.8 2.8"/><path d="M9.9 4.2A10.5 10.5 0 0 1 12 4c7 0 11 8 11 8a18 18 0 0 1-2.1 3.2"/><path d="M6.6 6.6C3.7 8.5 1 12 1 12s4 8 11 8a10.5 10.5 0 0 0 4.1-.8"/></svg>,
